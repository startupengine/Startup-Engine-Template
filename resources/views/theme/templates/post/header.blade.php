...
<div class="section" style="padding-top:25px;@if($post->content()->heading->header_size == "small") margin-top:-75px !important; @else margin-top:-150px !important; @endif background:none;z-index:1 !important;">
            ...
            <div style="width:100%;">
                <div id="articles">
                    <div id="content-row">
                        ...
                        <div class="card" style="text-align:center;box-shadow:0px -30px 30px rgba(0,0,100,0.1);background:linear-gradient(180deg, #fff 90%, #fff0 100%) !important;" id="contentBody">
