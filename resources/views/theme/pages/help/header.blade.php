...
<div class="wrapper">
    <div id="page-header" class="page-header page-header-small clear-filter" filter-color="black">
        <div id="header-image" class="page-header-image" data-parallax="true" style="@if($page->content()->heading->background == null)background-color:#3a92f1;@else background-image:url({{ $page->content()->heading->background }}); @endif">
        </div>
        <div class="container">
