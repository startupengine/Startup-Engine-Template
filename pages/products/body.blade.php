...
<div class="wrapper">
    <div class="main" >
        <div class="section section-examples bg-gradient-blue" style="min-height:100vh;">
            ...
            <div class="container text-center">
                <div class="row justify-content-md-center" id="screenshots">
                    ...
                    <div class="col-lg-6" style="margin-bottom:25px;">
                        <img src="https://psychoanalytics.s3-us-west-1.amazonaws.com/docs/screenshots/bH2w9VVLi3Hmwal2ydbV0Cjc0gAelqrydpe8SE2u.png" alt="Laravel" class="img-raised rounded">
                    ...
                    <div class="col-lg-6" style="margin-bottom:25px;">
                        <img src="https://psychoanalytics.s3-us-west-1.amazonaws.com/pages/products/ejinjFr2xPKaq27lB4QCRkDHdw45ayHjYLW4YMgM.jpeg" alt="Customer Psychology" class="img-raised rounded" >
